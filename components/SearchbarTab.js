    ...
    <div className=" hidden md:flex flex-row  items-center md:border-1 rounded-full h-[68px] w-[800px] md-shadow-sm bg-white justify-between font-bold dark:bg-gray-800 dark:text-gray-200">
      <div className="text-[12px] dark:text-gray-200 text-black h-[100%] w-[80%] flex flex-wrap content-center pl-7 border-r-2 rounded-l-full hover:rounded-full hover:transition transition transform duration-200 ease-out">
        ...
        <Popover
          ...
          PaperProps={{
            style: { width: "25%", height: "20%", borderRadius: "20px" },
          }}
        >
          {" "}
          <h1 className="font-bold text-xs p-7 dark:text-gray-200 dark:bg-gray-800" >GO ANYWHERE, ANYTIME</h1>
          <div
            className="flex flex-row justify-between items-center rounded-full h-[40%] border-1 shadow-lg hover:shadow-xl  transition duration-150 p-7 cursor-pointer dark:text-gray-200 dark:bg-gray-800 "
            onClick={() =>
              router.push(
          ...
          >
            <button className="font-bold text-purple-800 w-[100px] dark:text-gray-200 dark:bg-gray-800  ">
              I'm flexible
            </button>{" "}
            <video
      ...
      <div className="dark:text-gray-200 dark:bg-gray-800 flex flex-row hover:bg-gray-200 h-[100%] w-[75%] transition transform duration-200 ease-out rounded-full items-center space-x-5 pr-3">
        ...
        <SearchIcon className="flex h-12 w-20  bg-[#FE375B] dark:bg-red-400 text-white rounded-full md:p-2 cursor-pointer justify-end" />
      </div>
    </div>
  );
}
